...
foam.CLASS({
  ...
  name: 'MobileDAOBrowseControllerView',
  ...
  exports: [
//    'create as rightAction'
  ],

  requires: [
    'foam.nanos.mobile.controller.MobileDAOBrowserView',
...
//                  .end()
                  .startContext({ data: self }).tag(self.CREATE).addClass('create-btn').endContext()
                .end()

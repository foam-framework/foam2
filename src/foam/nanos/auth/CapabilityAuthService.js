        ...
        try {
          ...
          AbstractPredicate predicate = new AbstractPredicate(x) {
            ...
            public boolean f(Object obj) {
              ...
              if ( ( ucj.getStatus() == CapabilityJunctionStatus.GRANTED || ucj.getStatus() == CapabilityJunctionStatus.GRACE_PERIOD || ucj.getStatus() == CapabilityJunctionStatus.RENEWABLE ) &&

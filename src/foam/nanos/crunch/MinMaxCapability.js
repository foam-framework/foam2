  ...
  methods: [
    ...
    },
    {
      ...
      javaCode: `
        ...
        List<String> prereqCapabilityIds = crunchService.getPrereqs(x.put("subject", ucj.getSubject(x)), getId());
    ...
    },
    {
      ...
      javaCode: `
        ...
        List<String> ids = crunchService.getPrereqs(x.put("subject", ucj.getSubject(x)), getId());

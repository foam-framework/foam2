...
public class GoogleApiAuthService {
    ...
    public static Credential getCredentials(com.google.api.client.http.javanet.NetHttpTransport HTTP_TRANSPORT, List<String> scopes) throws java.io.IOException {

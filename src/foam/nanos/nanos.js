...
FOAM_FILES([
  ...
  { name: 'foam/nanos/notification/email/ProxyEmailService' },
  { name: 'foam/nanos/notification/email/UnimplementedEmailService' },
  { name: 'foam/nanos/notification/email/TemplateEmailService' },

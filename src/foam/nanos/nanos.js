...
FOAM_FILES([
  ...
  { name: "foam/nanos/medusa/BatchCmd" },
  { name: "foam/nanos/medusa/BatchClientDAO" },
  { name: "foam/nanos/medusa/BatchServerDAO" },
  ...
  { name: "foam/nanos/medusa/ClusterPingService" },
  { name: "foam/nanos/medusa/ClusterServerDAO" },
  { name: "foam/nanos/medusa/ClusterTopology" },
  { name: "foam/nanos/medusa/ClusterTopologyMonitor" },
  { name: "foam/nanos/medusa/ClusterTopologySink" },

...
FOAM_FILES([
  ...
  { name: "foam/nanos/medusa/MedusaClientDAO" },
  { name: "foam/nanos/medusa/MedusaEntryConsensusDAO" },
  { name: "foam/nanos/medusa/MedusaEntryDistributionDAO" },
  { name: "foam/nanos/medusa/MedusaEntryHashingDAO" },
  { name: "foam/nanos/medusa/MedusaEntryIdDAO" },
  ...
  { name: "foam/nanos/medusa/MedusaRegionDAO" },
  ...
  { name: "foam/nanos/medusa/MedusaEntryUniqueDAO" },
  { name: "foam/nanos/medusa/MedusaType" },
  { name: "foam/nanos/medusa/RegionStatus" },
  { name: "foam/nanos/medusa/ReplayBatchCmd" },
  { name: "foam/nanos/medusa/ReplayBatchSink" },

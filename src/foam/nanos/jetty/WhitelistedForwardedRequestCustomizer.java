...
public class WhitelistedForwardedRequestCustomizer extends ForwardedRequestCustomizer
{
  ...
  private final static Pattern IPV6_STD_PATTERN = SafePattern.compile("^(?:[0-9a-fA-F]{1,4}:){7}[0-9a-fA-F]{1,4}$");
  private final static Pattern IPV6_HEX_COMPRESSED_PATTERN = SafePattern.compile("^((?:[0-9A-Fa-f]{1,4}(?::[0-9A-Fa-f]{1,4})*)?)::((?:[0-9A-Fa-f]{1,4}(?::[0-9A-Fa-f]{1,4})*)?)$");

...
foam.CLASS({
  ...
  classes: [
    {
      ...
      methods: [
        function inTarget(x, y) {
          return this.inTriangle(x, y, 200, 300, 120, 140) ||
                 this.inCircle(x, y, 125, 250, 80) ||
                 this.inCircle(x, y, 275, 250, 80);
        },
  ...
  methods: [
    function initCView() {
      ...
      for ( var i = 0 ; i < 50 ; i++ ) {
        this.add(this.Series.create({x:50, y: 70+9*i, width: 400, lineWidth: 1.5, color: 'black'}));
      }
    }
  ]
});

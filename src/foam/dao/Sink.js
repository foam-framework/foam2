  ...
  methods: [
    {
      ...
      swiftCode: '_ = ((try? dao?.put(obj as? foam_core_FObject)) as foam_core_FObject??)'
    },
    {
      name: 'remove',
      code: function(o) {
      ...
      swiftCode: '_ = ((try? dao?.remove(obj as? foam_core_FObject)) as foam_core_FObject??)'
    },
    {
      name: 'eof',
      code: function() {},
    ...
    },
    {
      ...
      swiftCode: '_ = ((try? dao?.removeAll()) as ()??)',
    }
  ]
});

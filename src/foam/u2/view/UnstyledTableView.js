  ...
  properties: [
    ...
    },
    {
      ...
      expression: function(columns, of, memento) {
        ...
        var ls =  memento.paramsDict['columns'] ? memento.paramsDict['columns'].map(c => this.columnConfigToPropertyConverter.returnPropertyNameForLabel(of, c.name)) : JSON.parse(localStorage.getItem(of.id));
        return ls || columns;
      }
    },
    {

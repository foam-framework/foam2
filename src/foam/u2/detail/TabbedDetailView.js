              ...
              var e = this.E()
                .start(self.Tabs, {}, self.tabs$)
                  .forEach(sections, function(s, i) {
                    ...
                    this
                      .start(self.Tab, { label$: title$ || self.defaultSectionLabel, selected: self.memento && self.memento.paramsObj && self.memento.paramsObj.sT && self.memento.paramsObj && self.memento.paramsObj.sT === s.title }, tab)
                        .call(function() {

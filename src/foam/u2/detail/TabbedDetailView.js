              ...
              var e = this.E()
                .start(self.Tabs, {}, self.tabs$)
                  .forEach(sections, function(s, i) {
                    ...
                    this
                      .start(self.Tab, { label$: title$ || self.defaultSectionLabel, selected: self.memento && self.memento.paramsObj.selectedTab && self.memento.paramsObj.selectedTab === s.title }, tab)
                        .call(function() {

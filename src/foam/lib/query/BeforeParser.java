...
public class BeforeParser extends foam.lib.parse.ProxyParser {

  public BeforeParser() {
    setDelegate(
        new Seq(new FieldName(), 
                new Alt(new Literal("<="),
                        new Literal("<"), 
  ...
  public PStream parse(PStream ps, ParserContext x) {
    ...
    foam.mlang.predicate.Binary predicate = values[1].equals("<") ? new foam.mlang.predicate.Lt()
        : new foam.mlang.predicate.Lte();

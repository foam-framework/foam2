...
//  { name: "foam/u2/Element", flags: ['web'] },
  ...
  { name: "foam/box/node/SocketAddressable", flags: ['node'] },
  { name: "foam/box/node/SocketBindBox", flags: ['node'] },
  { name: "foam/box/node/PeerServerBox", flags: ['node'] },
  { name: "foam/box/node/ServerBox", flags: ['node'] },

...
//  { name: "lib/u2", flags: ['web'] },
  ...
  { name: "foam/dao/dao" },
  { name: "lib/mlang" },
  { name: "core/Relationship" }, // depends on mlang.Expressions?
  ...
  { name: "lib/u2/ActionView", flags: ['web'] },
  { name: "lib/u2/PropertyView", flags: ['web'] },
  { name: "lib/u2/DetailPropertyView", flags: ['web'] },
  { name: "lib/u2/DetailView", flags: ['web'] },
  { name: "lib/u2/tag/Image", flags: ['web'] },
  { name: "lib/u2/tag/Input", flags: ['web'] },
  { name: "lib/u2/TextField", flags: ['web'] },
  { name: "lib/node/net", flags: ['node'] },

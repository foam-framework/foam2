...
//  { name: "foam/u2/Element", flags: ['web'] },
  ...
  { name: "foam/comics/RelationshipDAOAddController", flags: ['web'] },
  { name: "foam/comics/RelationshipDAOAddControllerView", flags: ['web'] },
  { name: "foam/comics/RelationshipDAOController", flags: ['web'] },
  { name: "foam/comics/RelationshipDAOControllerView", flags: ['web'] },

...
//  { name: "foam/mlang/order/ComparatorJava", flags: ['java'] },
  ...
  { name: 'foam/nanos/docusign/documents/DocuSignTag' },
  { name: 'foam/nanos/docusign/documents/DocuSignString' },
  { name: 'foam/nanos/docusign/documents/DocuSignWritable' },
  { name: 'foam/nanos/docusign/documents/DocuSignDocument' },
  { name: 'foam/nanos/docusign/DocuSignConfig' },
  { name: 'foam/nanos/docusign/DocuSignSendToMeDAO' },
  { name: 'foam/nanos/docusign/model/DocuSignSession' },
  { name: 'foam/nanos/docusign/api/DocuSignAccessTokens' },

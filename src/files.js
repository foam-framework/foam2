...
FOAM_FILES([
  ...
  { name: 'foam/nanos/mobile/ui/TopSideNavigation', flags: ['web']},
  { name: 'foam/nanos/mobile/ui/TopNavigation', flags: ['web']},
...
//  { name: "foam/mlang/order/ComparatorJava", flags: ['java'] },
  ...
  { name: "foam/nanos/mobile/controller/MobileDAOBrowseControllerView" },
  { name: "foam/nanos/mobile/controller/MobileDAOBrowserView" },

          ...
          return function r(o, s, l) {
                ...
                e.controllers.bar = e.DatasetController.extend({
                  ...
                  calculateBarValuePixels: function(t, e) {
                    ...
                    if (m || void 0 === m && void 0 !== p)
                      for (n = 0; n < t; ++n)(i = l.getDatasetMeta(n)).bar && i.stack === p && i.controller.getValueScaleId() === d.id && l.isDatasetVisible(n) && (a = d.getRightValue(c[n].data[e]), (f < 0 && a < 0 || 0 <= f && 0 < a) && (v += a));
                    return r = d.getPixelForValue(v), s = ((o = d.getPixelForValue(v + f)) - r) / 2, void 0 !== g && Math.abs(s) < g && (s = g, o = 0 <= f && !h || f < 0 && h ? r - g : r + g), {
                      size: s,
                      base: r,
                      head: o,
                      center: o + s / 2
                ...
                t.controllers.radar = t.DatasetController.extend({
                  ...
                  update: function(t) {
                    var e, n, i = this,
                        ...
                        s = r.custom || {},
                        l = i.getDataset(),
                        u = i.chart.options.elements.line,
                        d = i.chart.scale;
                    for (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), h.extend(a.dataset, {
                      _datasetIndex: i.index,
                      _scale: d,
                      _children: o,
                      _loop: !0,
                      _model: {
                        tension: s.tension ? s.tension : h.valueOrDefault(l.lineTension, u.tension),
                        backgroundColor: s.backgroundColor ? s.backgroundColor : l.backgroundColor || u.backgroundColor,
                        borderWidth: s.borderWidth ? s.borderWidth : l.borderWidth || u.borderWidth,
                        borderColor: s.borderColor ? s.borderColor : l.borderColor || u.borderColor,
                        fill: s.fill ? s.fill : void 0 !== l.fill ? l.fill : u.fill,
                        borderCapStyle: s.borderCapStyle ? s.borderCapStyle : l.borderCapStyle || u.borderCapStyle,
                        borderDash: s.borderDash ? s.borderDash : l.borderDash || u.borderDash,
                        borderDashOffset: s.borderDashOffset ? s.borderDashOffset : l.borderDashOffset || u.borderDashOffset,
                        borderJoinStyle: s.borderJoinStyle ? s.borderJoinStyle : l.borderJoinStyle || u.borderJoinStyle
                      }
                    }), a.dataset.pivot(), e = 0, n = o.length; e < n; e++) i.updateElement(o[e], e, t);
                  ...
                  updateElement: function(t, e, n) {
                    ...
                    void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius), void 0 !== r.hitRadius && void 0 === r.pointHitRadius && (r.pointHitRadius = r.hitRadius), h.extend(t, {
                      ...
                      _model: {
                        x: n ? o.xCenter : l.x,
                        y: n ? o.yCenter : l.y,
                        tension: a.tension ? a.tension : h.valueOrDefault(r.lineTension, i.chart.options.elements.line.tension),
                        radius: a.radius ? a.radius : h.valueAtIndexOrDefault(r.pointRadius, e, s.radius),
                        backgroundColor: a.backgroundColor ? a.backgroundColor : h.valueAtIndexOrDefault(r.pointBackgroundColor, e, s.backgroundColor),
                        borderColor: a.borderColor ? a.borderColor : h.valueAtIndexOrDefault(r.pointBorderColor, e, s.borderColor),
                        borderWidth: a.borderWidth ? a.borderWidth : h.valueAtIndexOrDefault(r.pointBorderWidth, e, s.borderWidth),
                        pointStyle: a.pointStyle ? a.pointStyle : h.valueAtIndexOrDefault(r.pointStyle, e, s.pointStyle),
                        rotation: a.rotation ? a.rotation : h.valueAtIndexOrDefault(r.pointRotation, e, s.rotation),
                        hitRadius: a.hitRadius ? a.hitRadius : h.valueAtIndexOrDefault(r.pointHitRadius, e, s.hitRadius)
                      }
            ...
            27: [function(t, e, n) {
              ...
              var g = t(2),
                  m = t(46);
              var i = function(t) {
                m.extend(this, t), this.initialize.apply(this, arguments)
              };
              m.extend(i.prototype, {
                ...
                pivot: function() {
                  var t = this;
                  return t._view || (t._view = m.clone(t._model)), t._start = {}, t
                },
                transition: function(t) {
                  var e = this,
                      n = e._model,
                    ...
                    for (a = 0, r = f.length; a < r; ++a)
                      if (u = n[o = f[a]], e.hasOwnProperty(o) || (e[o] = u), (s = e[o]) !== u && "_" !== o[0]) {
                        if (t.hasOwnProperty(o) || (t[o] = s), (d = typeof u) == typeof(l = t[o]))
                          ...
                          } else if (m.isFinite(l) && m.isFinite(u)) {
                            e[o] = l + (u - l) * i;
                            continue
                          }
                        e[o] = u
                ...
                hasValue: function() {
                  return m.isNumber(this._model.x) && m.isNumber(this._model.y)
                }
              }), i.extend = m.inherits, e.exports = i
            }, {
              2: 2,
              46: 46
            }],
            ...
            33: [function(t, e, n) {
              ...
              function B(t, e, n) {
                ...
                return n && (1 === t.getTicks().length ? i -= t.isHorizontal() ? Math.max(i - t.left, t.right - i) : Math.max(i - t.top, t.bottom - i) : i -= 0 === e ? (t.getPixelForTick(1) - i) / 2 : (i - t.getPixelForTick(e - 1)) / 2), i
              }
              ...
              function M(t) {
                ...
                return {
                  ...
                  style: a,
                  family: r,
                  font: H.fontString(i, a, r)
                }
              }

              function E(t) {
                return H.options.toLineHeight(H.valueOrDefault(t.lineHeight, 1.2), H.valueOrDefault(t.fontSize, _.global.defaultFontSize))
              }
              _._set("scale", {
                display: !0,
                position: "left",
                ...
                calculateTickRotation: function() {
                  ...
                  if (i.length && t.options.display && t.isHorizontal())
                    for (var o, s = H.longestText(e, a.font, i, t.longestTextCache), l = s, u = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; u < l && r < n.maxRotation;) {
                      var d = H.toRadians(r);
                ...
                fit: function() {
                  ...
                  if (e.width = l ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : s && o.drawTicks ? d : 0, e.height = l ? s && o.drawTicks ? d : 0 : t.maxHeight, r.display && s) {
                    var h = E(r) + H.options.toPadding(r.padding).height;
                    l ? e.height += h : e.width += h
                  }
                  if (a.display && s) {
                    var c = H.longestText(t.ctx, u.font, n, t.longestTextCache),
                        f = H.numberOfLabelLines(n),
                        g = .5 * u.size,
                        m = t.options.ticks.padding;
                    if (l) {
                      t.longestLabelWidth = c;
                      var p = H.toRadians(t.labelRotation),
                          v = Math.cos(p),
                          b = Math.sin(p) * c + u.size * f + g * (f - 1) + g;
                      e.height = Math.min(t.maxHeight, e.height + b + m), t.ctx.font = u.font;
                      var y = w(t.ctx, n[0], u.font),
                ...
                draw: function(S) {
                  ...
                  if (C.display) {
                    var o = D.ctx,
                        ...
                        I = 0 !== D.labelRotation,
                        A = D.isHorizontal(),
                        n = T.autoSkip ? D._autoSkip(D.getTicks()) : D.getTicks(),
                        s = H.valueOrDefault(T.fontColor, P.defaultFontColor),
                        l = M(T),
                        u = H.valueOrDefault(t.fontColor, P.defaultFontColor),
                        d = M(t),
                        F = O.drawTicks ? O.tickMarkLength : 0,
                        i = H.valueOrDefault(e.fontColor, P.defaultFontColor),
                        a = M(e),
                        r = H.options.toPadding(e.padding),
                        R = H.toRadians(D.labelRotation),
                        L = [],
                        Y = D.options.gridLines.lineWidth,
                        W = "right" === C.position ? D.left : D.right - Y - F,
                        N = "right" === C.position ? D.left + F : D.right,
                        z = "bottom" === C.position ? D.top + Y : D.bottom - F - Y,
                        V = "bottom" === C.position ? D.top + Y + F : D.bottom + Y;
                    if (H.each(n, function(t, e) {
                      if (!H.isNullOrUndef(t.label)) {
                        var n, i, a, r, o, s, l, u, d, h, c, f, g, m, p = t.label;
                        r = e === D.zeroLineIndex && C.offset === O.offsetGridLines ? (n = O.zeroLineWidth, i = O.zeroLineColor, a = O.zeroLineBorderDash, O.zeroLineBorderDashOffset) : (n = H.valueAtIndexOrDefault(O.lineWidth, e), i = H.valueAtIndexOrDefault(O.color, e), a = H.valueOrDefault(O.borderDash, P.borderDash), H.valueOrDefault(O.borderDashOffset, P.borderDashOffset));
                        var v = "middle",
                            b = "middle",
                            y = T.padding;
                        if (A) {
                          ...
                          var _ = B(D, e, O.offsetGridLines);
                          _ < D.left - 1e-7 && (i = "rgba(0,0,0,0)"), _ += H.aliasPixel(n), g = D.getPixelForTick(e) + T.labelOffset, o = l = d = c = _, s = z, u = V, h = S.top, f = S.bottom + Y
                        } else {
                          var k, w = "left" === C.position;
                          k = T.mirror ? (v = w ? "left" : "right", y) : (v = w ? "right" : "left", F + y), g = w ? D.right - k : D.left + k;
                          var M = B(D, e, O.offsetGridLines);
                          M < D.top - 1e-7 && (i = "rgba(0,0,0,0)"), M += H.aliasPixel(n), m = D.getPixelForTick(e) + T.labelOffset, o = W, l = N, d = S.left, c = S.right + Y, s = u = h = f = M
                        }
                        L.push({
                          tx1: o,
                          ty1: s,
                      ...
                      var h, c, f = 0,
                          g = E(e) / 2;
                      if (A) h = D.left + (D.right - D.left) / 2, c = "bottom" === C.position ? D.bottom - g - r.bottom : D.top + g + r.top;
                      else {
                        var m = "left" === C.position;
                        h = m ? D.left + g + r.top : D.right - g - r.top, c = D.top + (D.bottom - D.top) / 2, f = m ? -.5 * Math.PI : .5 * Math.PI
                      }
                      o.save(), o.translate(h, c), o.rotate(f), o.textAlign = "center", o.textBaseline = "middle", o.fillStyle = i, o.font = a.font, o.fillText(e.labelString, 0, 0), o.restore()
                    }
                    if (O.drawBorder) {
                      o.lineWidth = H.valueAtIndexOrDefault(O.lineWidth, 0), o.strokeStyle = H.valueAtIndexOrDefault(O.color, 0);
                      var p = D.left,
                          v = D.right + Y,
                          b = D.top,
                          y = D.bottom + Y,
                          x = H.aliasPixel(o.lineWidth);
                      A ? (b = y = "top" === C.position ? D.bottom : D.top, b += x, y += x) : (p = v = "left" === C.position ? D.right : D.left, p += x, v += x), o.beginPath(), o.moveTo(p, b), o.lineTo(v, y), o.stroke()
                    }
                  }
                }
              })
              ...
              u._set("global", {
                ...
                draw: function(t) {
                  var e = this._view,
                      ...
                      s = e.x,
                      l = e.y;
                  e.skip || (void 0 === t || n.x > t.left - 1e-7 && t.right + 1e-7 > n.x && n.y > t.top - 1e-7 && t.bottom + 1e-7 > n.y) && (i.strokeStyle = e.borderColor || h, i.lineWidth = d.valueOrDefault(e.borderWidth, u.global.elements.point.borderWidth), i.fillStyle = e.backgroundColor || h, d.canvas.drawPoint(i, a, o, s, l, r))
                }
              })
            }, {
              26: 26,
                ...
                var a, r = i.time,
                    o = r.unit || function(t, e, n, i) {
                      ...
                      for (a = _.indexOf(t); a < s - 1; ++a)
                        if (o = (r = x[_[a]]).steps ? r.steps[r.steps.length - 1] : b, r.common && Math.ceil((n - e) / (o * r.size)) <= i) return _[a];
                      return _[s - 1]
                    }(r.minUnit, t, e, n),
                    s = C(o),
                ...
                var t = i.extend({
                  ...
                  determineDataLimits: function() {
                    var t, e, n, i, a, r, o = this,
                        ...
                        g = [],
                        m = s.data.labels || [];
                    for (t = 0, n = m.length; t < n; ++t) g.push(D(m[t], o));
                    for (t = 0, n = (s.data.datasets || []).length; t < n; ++t)
                      if (s.isDatasetVisible(t))
                        if (a = s.data.datasets[t].data, p.isObject(a[0]))
                          for (f[t] = [], e = 0, i = a.length; e < i; ++e) r = D(a[e], o), c.push(r), f[t][e] = r;
                    else c.push.apply(c, g), f[t] = g.slice(0);
                    else f[t] = [];
                    g.length && (g = w(g).sort(k), d = Math.min(d, g[0]), h = Math.max(h, g[g.length - 1])), c.length && (c = w(c).sort(k), d = Math.min(d, c[0]), h = Math.max(h, c[c.length - 1])), d = D(l.min, o) || d, h = D(l.max, o) || h, d = d === b ? +y().startOf(u) : d, h = h === v ? +y().endOf(u) + 1 : h, o.min = Math.min(d, h), o.max = Math.max(d + 1, h), o._horizontal = o.isHorizontal(), o._table = [], o._timestamps = {
                      data: c,
                      datasets: f,
                      labels: g
                    }
                  ...
                  buildTicks: function() {
                    ...
                    case "auto":
                    default:
                      v = P(f, g, c.getLabelCapacity(f), m)
                    }
                    for ("ticks" === m.bounds && v.length && (f = v[0], g = v[v.length - 1]), f = D(p.min, c) || f, g = D(p.max, c) || g, t = 0, e = v.length; t < e; ++t) f <= (n = v[t]) && n <= g && b.push(n);
                    return c.min = f, c.max = g, c._unit = p.unit || function(t, e, n, i) {
                    ...
                    }(b, p.minUnit, c.min, c.max), c._majorUnit = C(c._unit), c._table = function(t, e, n, i) {
                      ...
                      return u
                    }(c._timestamps.data, f, g, m.distribution), c._offsets = (i = c._table, a = b, r = f, o = g, h = d = 0, (s = m).offset && a.length && (s.time.min || (l = 1 < a.length ? a[1] : o, u = a[0], d = (M(i, "time", l, "pos") - M(i, "time", u, "pos")) / 2), s.time.max || (l = a[a.length - 1], u = 1 < a.length ? a[a.length - 2] : r, h = (M(i, "time", l, "pos") - M(i, "time", u, "pos")) / 2)), {
                      left: d,
                      right: h
                  ...
                  getLabelForIndex: function(t, e) {
                    ...
                    return p.isObject(r) && (a = this.getRightValue(r)), i.tooltipFormat ? S(a, i).format(i.tooltipFormat) : "string" == typeof a ? a : S(a, i).format(this._labelFormat)
                  },
                  ...
                  getPixelForValue: function(t, e, n) {
                    var i = null;
                    if (void 0 !== e && void 0 !== n && (i = this._timestamps.datasets[n][e]), null === i && (i = D(t, this)), null !== i) return this.getPixelForOffset(i)
                  },
                  getPixelForTick: function(t) {
                    var e = this.getTicks();

...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    Context.GLOBAL.registerClass(cls: SkipDAO.classInfo())
    Context.GLOBAL.registerClass(cls: ProxyDAO.classInfo())
    Context.GLOBAL.registerClass(cls: ResetListener.classInfo())
    Context.GLOBAL.registerClass(cls: PredicatedSink.classInfo())
    Context.GLOBAL.registerClass(cls: PipeSink.classInfo())
    Context.GLOBAL.registerClass(cls: OrderedSink.classInfo())
    Context.GLOBAL.registerClass(cls: OrderedDAO.classInfo())
    Context.GLOBAL.registerClass(cls: LimitedSink.classInfo())
    Context.GLOBAL.registerClass(cls: LimitedDAO.classInfo())
    Context.GLOBAL.registerClass(cls: InternalException.classInfo())
    Context.GLOBAL.registerClass(cls: Exception.classInfo())
    Context.GLOBAL.registerClass(cls: FilteredDAO.classInfo())
    Context.GLOBAL.registerClass(cls: ExternalException.classInfo())
    Context.GLOBAL.registerClass(cls: And.classInfo())
    Context.GLOBAL.registerClass(cls: Nary.classInfo())
    Context.GLOBAL.registerClass(cls: AbstractPredicate.classInfo())
    Context.GLOBAL.registerClass(cls: Or.classInfo())
    Context.GLOBAL.registerClass(cls: True.classInfo())
    Context.GLOBAL.registerClass(cls: False.classInfo())
    Context.GLOBAL.registerClass(cls: ProxyListener.classInfo())

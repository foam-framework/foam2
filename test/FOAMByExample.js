...
Test.getAxioms().forEach(function(a) { console.log(a.cls_ && a.cls_.name, a.name); });
 ...
 log("Exception: ", x);
  ...
  expect(log_.output).toMatchGolden({ i: 12, str: "Property aProperty bMethod f1Method f2 __context__Method initArgsMethod unknownArgTopic propertyChangeMethod describeMethod toJSONMethod objectify" });
...
log(Test.getAxiomsByClass(foam.core.Method).map(foam.core.Method.NAME.f));
 ...
 log("Exception: ", x);
  ...
  expect(log_.output).toMatchGolden({ i: 16, str: " <b>&gt;</b> f1,f2,initArgs,unknownArg,describe,toJSON,objectify" });
...
log(Test.getAxiomsByClass(foam.core.Method).sort(foam.core.Method.NAME.compare).map(foam.core.Method.NAME.f));
 ...
 log("Exception: ", x);
  ...
  expect(log_.output).toMatchGolden({ i: 17, str: " <b>&gt;</b> describe,f1,f2,initArgs,objectify,toJSON,unknownArg" });
...
log(e.get());
 ...
 log("Exception: ", x);
  ...
  expect(log_.output).toMatchGolden({ i: 84, str: " <b>&gt;</b> John Smith <b>&gt;</b> [object Object] propertyChange value [object Object] <b>&gt;</b> [object Object] propertyChange value [object Object] <b>&gt;</b> Steve Jones" });
